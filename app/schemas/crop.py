...
class CropResponse(BaseModel):
    ...
    ideal_temperature_simple: str = Field(description="Ideal temperature range in plain language")
    humidity: str = Field(description="Ideal humidity range")
    humidity_simple: str = Field(description="Ideal humidity range in plain language")
    precipitation: str = Field(description="Ideal precipitation range")
    precipitation_simple: str = Field(description="Ideal precipitation range in plain language")
    altitude: str = Field(description="Ideal altitude range")
    altitude_simple: str = Field(description="Ideal altitude range in plain language")
